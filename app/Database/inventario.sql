...
CREATE TABLE equipo (
    ...
    CONSTRAINT fk_equipo_categoria FOREIGN KEY (idCateEquipo) REFERENCES cateEquipo(idCateEquipo),
    CONSTRAINT fk_equipo_marca FOREIGN KEY (idMarca) REFERENCES marcaEquipo(idMarca)
) ENGINE=INNODB;
...
CREATE TABLE movimientoEquipo (
    ...
    CONSTRAINT fk_movimiento_equipo FOREIGN KEY (idEquipo) REFERENCES equipo(idEquipo)
) ENGINE=INNODB;
...
CREATE TABLE equipoUbicacion (
    ...
    CONSTRAINT fk_equipoUbicacion_equipo FOREIGN KEY (idEquipo) REFERENCES equipo(idEquipo),
    CONSTRAINT fk_equipoUbicacion_ubicacion FOREIGN KEY (idUbicacion) REFERENCES ubicacion(idUbicacion)
) ENGINE=INNODB;
