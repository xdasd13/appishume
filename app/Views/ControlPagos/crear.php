            ...
            <div class="card card-3d animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/controlpagos/guardar') ?>" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="idcontrato" name="idcontrato" required>
                                        <option value="">Seleccione un contrato con deuda</option>
                                        <?php if (!empty($contratos)): ?>
                                            <?php foreach ($contratos as $contrato): ?>
                                                <option value="<?= $contrato['idcontrato'] ?>" <?= (isset($contrato_seleccionado) && $contrato_seleccionado == $contrato['idcontrato']) ? 'selected' : '' ?>>
                                                    Contrato #<?= $contrato['idcontrato'] ?> -
                                                    <?= !empty($contrato['nombres']) ?
                                                        $contrato['nombres'] . ' ' . $contrato['apellidos'] :
                                                        $contrato['razonsocial'] ?>
                                                    (Saldo: S/ <?= number_format($contrato['saldo_actual'] ?? 0, 2) ?>)
                                                </option>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <option value="">No hay contratos con deuda pendiente</option>
                                        <?php endif; ?>
                                    </select>
                                    <small class="form-text text-muted">Solo se muestran contratos con deuda
                                        pendiente</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <!-- Nueva sección para subir comprobante -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>¿Desea subir comprobante? *</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subir_comprobante"
                                            id="comprobante_si" value="si" required>
                                        <label class="form-check-label" for="comprobante_si">Sí</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="subir_comprobante"
                                            id="comprobante_no" value="no" checked>
                                        <label class="form-check-label" for="comprobante_no">No</label>
                                    </div>
                                    <small class="form-text text-muted">Seleccione si desea adjuntar un comprobante de
                                        pago</small>
                                </div>
                            </div>
                        </div>

                        <!-- Campos condicionales para tipo de pago y comprobante -->
                        <div class="row" id="campos-transferencia">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Ingrese el número de transacción bancaria o
                                        referencia de pago</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="campo-comprobante">
                                    ...
                                    <small class="form-text text-muted">Formatos permitidos: PNG, JPG, JPEG, PDF (Máx.
                                        2MB)</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="dni_pagador" name="dni_pagador"
                                            maxlength="8" pattern="[0-9]{8}" required placeholder="Ingrese 8 dígitos">
                                    ...
                                    <small class="form-text text-muted">Ingrese el DNI de la persona que realiza el
                                        pago</small>
                                    <div id="dni-feedback" class="mt-2"></div>
                                    <div id="privacy-notice-pagador" class="alert alert-info mt-2"
                                        style="display: none;">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        <small>Los datos fueron obtenidos de RENIEC y están protegidos por la Ley de
                                            Protección de Datos Personales</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Se completará automáticamente al validar el
                                        DNI</small>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fechahora" name="fechahora"
                                        value="<?= getPeruDateTimeFormatted() ?>" readonly
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div id="resumen-pago" class="card card-info" style="display: none;">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0"><i class="fas fa-calculator mr-2"></i>Resumen del
                                            Pago</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <p><strong>Monto Total:</strong><br>
                                                    <span class="h5 text-primary">S/ <span
                                                            id="resumen-monto">0.00</span></span>
                                                </p>
                                            </div>
                                            <div class="col-md-3">
                                                <p><strong>Saldo Actual:</strong><br>
                                                    <span class="h5 text-warning">S/ <span
                                                            id="resumen-saldo">0.00</span></span>
                                                </p>
                                            </div>
                                            <div class="col-md-3">
                                                <p><strong>Amortización:</strong><br>
                                                    <span class="h5 text-success">S/ <span
                                                            id="resumen-amortizacion">0.00</span></span>
                                                </p>
                                            </div>
                                            <div class="col-md-3">
                                                <p><strong>Nuevo Saldo:</strong><br>
                                                    <span class="h5" id="resumen-nuevo-saldo-text">S/ <span
                                                            id="resumen-nuevo-saldo">0.00</span></span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                <div id="alerta-completo" class="alert alert-success"
                                                    style="display: none;">
                                                    <i class="fas fa-check-circle mr-2"></i>¡El contrato quedará
...
<script>
    $(document).ready(function () {
        ...
        // Controlar visibilidad de campos según tipo de pago y comprobante
        function toggleCamposTipoPago() {
            ...
            var subirComprobante = $('input[name="subir_comprobante"]:checked').val();
            ...
            // Controlar campo de comprobante
            if (subirComprobante === 'si') {
                $('#campo-comprobante').show();
                $('#comprobante').attr('required', 'required');
            } else {
                $('#campo-comprobante').hide();
        ...
        // Escuchar cambios en la selección de comprobante
        $('input[name="subir_comprobante"]').on('change', function () {
            toggleCamposTipoPago();
        });
        ...
        $('#pagoForm').on('submit', function (e) {
            ...
            // Validar comprobante si se seleccionó subir
            if (subirComprobante === 'si' && (!comprobante || !comprobante.name)) {
                errores.push('Debe seleccionar un archivo de comprobante');
            }
            ...
            Swal.fire({
                ...
                html: '<div class="text-left">' +
                    ...
                    '<p><strong>Subir Comprobante:</strong> ' + (subirComprobante === 'si' ? 'Sí' : 'No') + '</p>' +
