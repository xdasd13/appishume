                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mb-4">
                            <div class="d-flex align-items-center">
                                <div
                                    class="avatar avatar-sm bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mr-3">
                                    <?= substr($usuario_actual, 0, 1) ?>
                                </div>
                                <div>
                                    <h6 class="mb-0">Usuario que realizará la Entrega:
                                        <strong><?= $usuario_actual ?></strong></h6>
                                    <small>La entrega quedará registrada a nombre del usuario actualmente
                                        conectado</small>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <small class="form-text text-muted">Solo se muestran contratos pagados al 100%
                                                con fecha de evento hasta hoy</small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="idserviciocontratado"
                                            name="idserviciocontratado" required <?= isset($servicios) ? '' : 'disabled' ?>>
                                        ...
                                        <small class="form-text text-muted">Seleccione el servicio ya realizado para
                                            programar la entrega</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Nota:</strong> La fecha y hora de entrega se registrará automáticamente
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted mt-2">Describa el formato de entrega
                                            (físico/digital) y especificaciones</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Suba el comprobante de entrega en formato
                                            PDF (máx. 5MB)</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="confirmacion">
                                        Confirmo que el servicio ya fue realizado y la información de entrega es
                                        correcta
                                    </label>
                                </div>
                            </div>
